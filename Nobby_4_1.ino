...
unsigned long countdownTime = 7000;  //5 minutes in milliseconds (300000)
...
int samples = 10;  //accel calibration samples
int32_t sumZ = 0;
...
void setup() {
  ...
  int32_t avgZ = sumZ / samples;  //calibrate G meter on start-up
  if (avgZ > 0) {
